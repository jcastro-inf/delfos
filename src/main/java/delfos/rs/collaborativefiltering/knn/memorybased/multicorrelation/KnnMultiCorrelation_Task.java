 ...
 */
public class KnnMultiCorrelation_Task extends Task {

    public final int idUser;
    public final int idNeighbor;
    public KnnMultiCorrelation rs;
    public DatasetLoader<? extends Rating> datasetLoader;
    public Neighbor neighbor = null;

    public KnnMultiCorrelation_Task(DatasetLoader<? extends Rating> datasetLoader, int idUser, int idNeighbor, KnnMultiCorrelation rs) throws UserNotFound {
