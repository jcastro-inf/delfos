 ...
 */
public class FixedGroupSize_OnlyNGroups_withOverlapingMembers extends GroupFormationTechnique {
     ...
     * cuatro miembros.
     */
    public FixedGroupSize_OnlyNGroups_withOverlapingMembers() {
        super();
     ...
     */
    public FixedGroupSize_OnlyNGroups_withOverlapingMembers(int numGroupsValue, int groupSizeValue) {
        this();
