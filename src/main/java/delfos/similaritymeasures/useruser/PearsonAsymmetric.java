 ...
 * @author jcastro
 */
public class PearsonAsymmetric extends SimilarityMeasureAdapter implements CollaborativeSimilarityMeasure, UserUserSimilarity {
    ...
    private final PearsonCorrelationCoefficient pcc = new PearsonCorrelationCoefficient();
    ...
    public double similarity(Collection<CommonRating> commonRatings, RatingsDataset<? extends Rating> ratings) throws CouldNotComputeSimilarity {
        ...
        double cosine = pcc.similarity(commonRatings, ratings);
