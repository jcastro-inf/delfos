 ...
 * @author jcastro
 */
public class CosineAsymmetric extends SimilarityMeasureAdapter implements CollaborativeSimilarityMeasure, UserUserSimilarity {
    ...
    private final CosineCoefficient cosineCoefficient = new CosineCoefficient();
    ...
    public double similarity(Collection<CommonRating> commonRatings, RatingsDataset<? extends Rating> ratings) throws CouldNotComputeSimilarity {
        ...
        double cosine = cosineCoefficient.similarity(commonRatings, ratings);
