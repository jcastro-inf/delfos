 ...
 */
public final class StringsOrderings {
     ...
     * umlauts correctly and ignores upper/lower case differences.</p>
     *
     * @return
     * <p>
     * A string comparator that uses the current locale's order rules and
     * handles embedded numbers correctly.</p>
     ...
     * strings and handles embedded numbers correctly.</p>
     * <b>Do not use</b> if your app might ever run on any locale that uses more
     ...
     * <p>
     * This is probably the best default comparison to use.</p>
     * <p>
     ...
     * and pass it to
     * {@link #compareNatural(java.text.Collator, String, String)}</p>
     *
     ...
     * numbers based on their numeric values.</p>
     *
     * @param s first string
     * @param t second string
     * @return zero iff <code>s</code> and <code>t</code> are equal, a value
     ...
     * characters and the numeric values off any contained numbers.</p>
     * <p>
