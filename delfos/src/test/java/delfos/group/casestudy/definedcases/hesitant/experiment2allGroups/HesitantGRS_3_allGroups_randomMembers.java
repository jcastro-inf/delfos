...
public class HesitantGRS_3_allGroups_randomMembers extends DelfosTest {

    public HesitantGRS_3_allGroups_randomMembers() {
    }
    ...
    File experimentDirectory = new File(Constants.getTempDirectory().getAbsolutePath() + File.separator
            ...
            + HesitantGRS_3_allGroups_randomMembers.class.getSimpleName() + File.separator);
