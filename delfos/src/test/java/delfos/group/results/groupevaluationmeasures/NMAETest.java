...
public class NMAETest {
    ...
    public void test_noRecommendations_NMAEequalsNaN() {
        ...
        GroupRecommendationResult groupRecommendationResult = new GroupRecommendationResult(
                seed, buildTime, groupBuildTime, groupRecommendationTime, requests, results, "TestCaseAlias");
